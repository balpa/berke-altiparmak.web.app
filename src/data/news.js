    ...
    pages: [
      {
        ...
        kicker: '★ FRONT PAGE ★',
        subhead:
          'Beykent CompEng grad, YTU MSc — Software Developer at Insider One, three+ years on the Singapore Airlines dedicated team',
        byline: 'BY THE STAFF',
        lead:
    ...
    pages: [
      {
        ...
        kicker: '★ MANŞET ★',
        subhead:
          "Beykent Bilgisayar Mühendisi, Yıldız Teknik MSc — Insider One'da Software Developer, Singapore Airlines adanmış ekibinde 3+ yıl",
        byline: 'GAZETE EKİBİ',
        lead:
        ...
        secondary: {
          ...
          body:
            "Singapore Airlines'a adanmış mühendislik ekibinde üç yıl; yıllık 20M+ yolcuya personalization üretimi. 3 kişilik ekiple sıfırdan bir Banner Management ürünü; micro-frontend + micro-backend mimaride. Tüm delivery stack'i sıfırdan: Kubernetes (AWS EKS), Helm, Terraform, Docker, CI/CD. Backend microservice'ler Go ve PHP/Laravel; arkada MySQL ve Redis. Tüm kıdem boyunca her ay \"Success\" performans değerlendirmesi.",
        },
      },
      {
        title: 'TEKNOLOJİ',
